#Combines 2 original scripts for calculating diffuse fraction of solar radiaiton and standard operative
#  temperature for our extreme limits hummingbird manuscript. 
#  Code written by Pieter Beck, modified by Sarah Supp 2012-2014

#----------------------------------DIFFUSE FRACTION OF SOLAR RADIATION FUNCTIONS---------------------#
...
#----------------------------------STANDARD OPERATIVE TEMPERATURE FUNCTIONS---------------------#
# Diffuse_fraction_of_solar_radiation.R
#
# Pieter Beck (psabeck@gmail.com)
# 09-12-2013
...
Rabs.calc <- function(Sp, ApOVERA = 0.25, Sd, aS = 0.89, aL = 0.97, Li){
  ...
  #   aL: mean longwave absorptivity. The published range of values for birds, based on field/lab data, is 0.95-0.99, where 0.97 is the average.
