...
ggplot(site.dat, aes(jday)) + geom_histogram() + xlab("Julian day of the year") + ylab("number of birds") +
...
ggplot(yearly.climate, aes(yearly.Te.10C.q, winterNDVI)) + geom_point(alpha=0.75) + #stat_smooth(method="lm") + 
  ylab("average winter NDVI") + xlab("percentile days with Te \u2264 10 C") + geom_text_repel(aes(label=yr)) +
  theme_classic() + theme(text = element_text(size=15)) + 
