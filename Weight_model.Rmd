...
plot(site.dat$Weight ~ site.dat$Fat, col="light grey")
```
...
plot(site.dat$Weight ~ site.dat$PriMary.Molt, col="light grey")
````
...
plot(site.dat$Weight ~ site.dat$Body.Molt, col="light grey")
...
plot(site.dat$Weight ~ site.dat$Gorget.head.molt, col="light grey")
...
plot(site.dat$Weight ~ site.dat$Tail.Molt, col="light grey")
...
````{r}
source('/Users/sarah/Desktop/Dropbox/ActiveResearchProjects/Hummingbird_extreme_limits/Model_evaluation_v4.r')
````
