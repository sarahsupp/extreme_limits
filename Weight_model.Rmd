...
#overall response
ggplot(yearly.weight.stat[complete.cases(yearly.weight.stat),], aes(yearly.Te.10C.q, Weight)) + geom_point() + theme_bw() + stat_smooth(method="lm", aes(group=1)) + ylab("body mass(grams)")

ggplot(yearly.weight.stat[complete.cases(yearly.weight.stat),], aes(winterNDVI, Weight)) + geom_point() + theme_bw() + stat_smooth(method="lm", aes(group=1)) + ylab("body mass(grams)")

ggplot(yearly.weight.stat[complete.cases(yearly.weight.stat),], aes(yearly.Te.10C.q, Fat)) + geom_point() + theme_bw() + stat_smooth(method="lm", aes(group=1)) + ylab("fat score")

ggplot(yearly.weight.stat[complete.cases(yearly.weight.stat),], aes(winterNDVI, Fat)) + geom_point() + theme_bw() + stat_smooth(method="lm", aes(group=1)) + ylab("fat score")
```
