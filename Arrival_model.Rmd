...
ggplot(yearly.catch.stat[complete.cases(yearly.catch.stat),], aes(yearly.Te.10C.q, sess.quant.50)) + geom_point() + theme_bw() + facet_wrap(~LOC) #+ stat_smooth(method="lm", aes(group=1))

ggplot(yearly.catch.stat[complete.cases(yearly.catch.stat),], aes(winterNDVI, sess.quant.50)) + geom_point() + 
  theme_bw() + facet_wrap(~LOC) # + stat_smooth(method="lm", aes(group=1))

#overall response
ggplot(yearly.catch.stat[complete.cases(yearly.catch.stat),], aes(yearly.Te.10C.q, sess.quant.50)) + geom_point() + theme_bw() + stat_smooth(method="lm", aes(group=1))

ggplot(yearly.catch.stat[complete.cases(yearly.catch.stat),], aes(winterNDVI, sess.quant.50)) + geom_point() + theme_bw() + stat_smooth(method="lm", aes(group=1))
